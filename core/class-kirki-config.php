...
/**
 * The Xirki_Config object
 */
final class Xirki_Config {
	...
	/**
	 * Set to true if you want to completely disable any Xirki-generated CSS.
	 *
	 * @access protected
	 * @var bool
	 */
	 ...
	 *
	 * @access private
	 * @param string $config_id @see Xirki_Config::get_instance().
	 * @param array  $args      @see Xirki_Config::get_instance().
	 */
	private function __construct( $config_id = 'global', $args = array() ) {
		...
		// Apply any xirki_config global filters.
		$defaults = apply_filters( 'xirki_config', $defaults );
