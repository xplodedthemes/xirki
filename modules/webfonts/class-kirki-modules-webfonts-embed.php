...
final class Xirki_Modules_Webfonts_Embed {
	...
	public function the_css() {
		foreach ( $this->fonts_to_load as $font ) {
			...
			if ( ! class_exists( 'Xirki_Fonts_Downloader' ) ) {
				include_once wp_normalize_path( dirname( __FILE__ ) . '/class-xirki-fonts-downloader.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude
			}
			$downloader = new Xirki_Fonts_Downloader();
