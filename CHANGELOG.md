...
* Fix: Google-fonts processing for some font-weights. [#2106](https://xplodedthemes.com/pull/2106) props @dedalx
* Fix: SCSS support for the `code` control. [#2112](https://xplodedthemes.com/pull/2112) props @reiterbene
* Fix: Locally downloadding google-fonts. [#2118](https://xplodedthemes.com/pull/2118) props @plazorax
...
* Fix: `active_callback` argument for `dropdown-pages` control. [#2055](https://xplodedthemes.com/issues/2055)
* Fix: `color ` control issues when inside a repeater. [#2059](https://xplodedthemes.com/issues/2059)
...
* New: Add Gutenberg support [#2009](https://xplodedthemes.com/issues/2009) props @timelsass
...
* Fix: `xirki_modules` filter was not working. [#2023](https://xplodedthemes.com/issues/2023)
* Fix: Issue with google-fonts loading when in the customizer and the typography field uses `postMessage`. [#1988](https://xplodedthemes.com/issues/1988)
* Fix: Changed the priority for css-vars.
* Fix: Dependencies for the code control. [#2020](https://xplodedthemes.com/issues/2020)
* Fix: PHP 5.2 error `T_PAAMAYIM_NEKUDOTAYIM` [#2032](https://xplodedthemes.com/issues/2032)
...
* Fix: Repeater control JS issue if saved value is malformatted [#1879](https://xplodedthemes.com/issues/1879) - props @asilcetin.
* Fix: Preset control bug [#1882](https://xplodedthemes.com/issues/1882).
* Fix: JS error if an SVG is uploaded to an image control [#1883](https://xplodedthemes.com/issues/1883) Props @seantjohnson-dev
...
* Fix: multiselect in repeaters. Props @asilcetin [#1876](https://xplodedthemes.com/issues/1876).
...
* Fix: Color Palette: material colors 'light-blue' doesn't work [#1783](https://xplodedthemes.com/issues/1783).
* Fix: Google Fonts switch error [#1791](https://xplodedthemes.com/issues/1791).
* Fix: FontAwesome JS is being loaded even if you don't need it on front end [#1786](https://xplodedthemes.com/issues/1786).
* Fix: Color Palette: Active color before section title [#1782](https://xplodedthemes.com/issues/1782).
...
* Fix: Allow html on radio-buttonset choices [#1818](https://xplodedthemes.com/issues/1818).
* Fix: `Xirki_Helper::compare_values` vs. `field-dependencies.js` boolean issue (props @CaptJiggly) [#1825](https://xplodedthemes.com/issues/1825).
* Fix: `active_callback` not working for checkboxes [#1809](https://xplodedthemes.com/issues/1809).
* Fix: Nested `active_callback` args not working properly (AND|OR relations) [#1809](https://xplodedthemes.com/issues/1809).
* Fix: Updated google-fonts.
* Fix: Display typography with no default values [#1797](https://xplodedthemes.com/issues/1797).
* Fix: Define "normal" as a valid css-value for sanitizations [#1814](https://xplodedthemes.com/issues/1814).
* Fix: `background` controls now output `background-color` as simply `background` if no `background-image` is defined in the value [#1808](https://xplodedthemes.com/issues/1808).
* Fix: @media-queries fix due to minimized CSS. [#1787](https://xplodedthemes.com/issues/1787).
* Fix: `Xirki_Helper::compare_values` contains/in PHP warning if value doesn't exist in array [#1828](https://xplodedthemes.com/issues/1828).
* Fix: Invalid Value in the Dimension control [#1844](https://xplodedthemes.com/issues/1844).
* Fix: Add `fr` to the array of valid units used in validations [
86adedb](https://xplodedthemes.com/pull/1784/commits/86adedb8cd4c06c7e6538c3087233a6840dee562)
...
* Fix: clear button on color controls [#1720](https://xplodedthemes.com/issues/1720)
* Fix: PHP mode in code controls.
* Fix: `active_callback` not working for upload fields [#1732](https://xplodedthemes.com/issues/1732)
* Fix: accessibility issue on radio-buttonset controls [#1722](https://xplodedthemes.com/issues/1722)
* Fix: `active_callback` not working for cropped-image controls [#1752](https://xplodedthemes.com/issues/1752)
* Fix: added support for `button_labels` in image fields [#1173](https://xplodedthemes.com/issues/1173)
* Fix: Support for adding inline CSS to an already defined stylesheet.
* Fix: Sanitization in section & panel descriptions and priorities [#1759](https://xplodedthemes.com/issues/1759)
* Fix: `active_callback` support when using serialized options [#1745](https://xplodedthemes.com/issues/1745)
* Fix: Remove timepicker from date control [#1750](https://xplodedthemes.com/issues/1750)
* Fix: WebfontLoader improvements.
* Fix: Now using a datepicker for the `date` control [#1767](https://xplodedthemes.com/issues/1767)
...
* New: Now loading fontawesome from a CDN. smaller footprint for the plugin and async loading will improve performance for everyone [#1763](https://xplodedthemes.com/issues/1763)
...
* Fix: Allow HTML in labels and descriptions [#1705](https://xplodedthemes.com/issues/1705)
* Fix: Code controls minor refactor (now extends the `WP_Customize_Code_Editor_Control` class)
* Fix: Checkbox values sanitization inside repeater controls [#1715](https://xplodedthemes.com/issues/1715)
* Fix: JS error in dimension controls when not using a CSS unit [#1711](https://xplodedthemes.com/pull/1711) props @FrankM1
* Fix: AJAX issue on a host with weird config.
* New: Add `placeholder` argument in `select` controls [#1593](https://xplodedthemes.com/issues/1593)

## 3.0.20

December 13 2017, dev time: 1.5 hours

* Fix: Use `repeat` instead of `repeat-all` in background controls [#1701](https://xplodedthemes.com/issues/1701)
* Fix: Use `set_url_scheme()` when outputing images [#1697](https://xplodedthemes.com/issues/1697)
* Fix: `textarea` control is broken with HTML content [#1694](https://xplodedthemes.com/issues/1694) props @tutv95
* Fix: Typo in `radio` controls [#1699](https://xplodedthemes.com/issues/1699)
...
* Fix: Standards fonts sometimes not showing in typography control [#1689](https://xplodedthemes.com/issues/1689)
...
* Fix: In some cases options were not saved when using `option` instead of the default `theme_mod` [#1665](https://xplodedthemes.com/issues/1665)
* Fix: `link` control-type (alias of `url`) was not working [#1660](https://xplodedthemes.com/issues/1660)
* Fix: Allow using tabs & linebreaks when defining elements in the `output` argument [#1659](https://xplodedthemes.com/issues/1659)
* Fix: PHP Warning when using `code` controls without a `label` defined [#1658](https://xplodedthemes.com/issues/1658)
* Fix: Buttons inside `number` controls were not increasing/decreasing the values [#1648](https://xplodedthemes.com/issues/1648)
* Fix: JS error  - only on Safari - for Select controls [#1662](https://xplodedthemes.com/issues/1662)
* Fix: Unable to deselect all options from multiselect controls [#1670](https://xplodedthemes.com/issues/1670)
* Fix: `multicolor` controls missing the `alpha` channel [#1657](https://xplodedthemes.com/issues/1657)
* Fix: Unable to manually edit value in `multicolor` controls [#1666](https://xplodedthemes.com/issues/1666)
...
* New: Added `text-transform` to `typography` fields [#1642](https://xplodedthemes.com/issues/1642)
...
* New: Added support for "outer" sections [#1683](https://xplodedthemes.com/issues/1683)
* New: Added new `Xirki::remove_control()`, `Xirki::remove_section()` and `Xirki::remove_panel()` methods.
* New: Added 2 new filters: `xirki/{$config_id}/webfonts/skip_hidden` and `xirki/{$config_id}/css/skip_hidden` [#1678](https://xplodedthemes.com/issues/1678)
...
* Fix: `typography` controls not working when they are the only fields used [#1627](https://xplodedthemes.com/issues/1627)
* Fix: `slider` controls were not updating the numeric value visually in their textfield when the control was not using `postMessage` [#1633](https://xplodedthemes.com/issues/1627)
* Fix: Deprecated call to non-existing `Xirki_Styles_Frontend`, props @FrankM1 [#1644](https://xplodedthemes.com/issues/1644)
* Fix: Updated the customizer-styling module for compatibility with WP 4.9 [#1639](https://xplodedthemes.com/issues/1639)
* Fix: `code` controls were not using the corect `priority` [#1622](https://xplodedthemes.com/issues/1622)
* Fix: Multiple reports of errors in the console.
* New: Refactored the `number` controls [#1631](https://xplodedthemes.com/issues/1627)
* New: Refactored the `color` controls. [#1646](https://xplodedthemes.com/issues/1646)

## 3.0.15

November 12 2017, dev time: 5 minutes.

* Fix: PHP Warning in the `Xirki_Modules_Webfonts_Link` class [#1626](https://xplodedthemes.com/issues/1626)

## 3.0.14

November 11 2017, dev time: 4 hours.

* Fix: Duplicate subsets output in the Google Fonts URLs [#1618](https://xplodedthemes.com/issues/1618)
* Fix: Theme Check Warnings [#1613](https://xplodedthemes.com/issues/1613)
* Fix: Add Xirki version number when enqueueing scripts & styles (cache-busting) [#1623](https://xplodedthemes.com/issues/1623)
* Fix: JS conflict and PHP warning in typography fields when they are not properly defined [#1621](https://xplodedthemes.com/issues/1621)
...
* Fix: LTR for code controls [#1558](https://xplodedthemes.com/issues/1558)
* Fix: Remove Reset in default sections [#1580](https://xplodedthemes.com/issues/1580)
* Fix: Uncaught TypeError: data.value[choiceKey].replace is not a function [#1578](https://xplodedthemes.com/issues/1578)
...
* Fix: Allow HTML tags in tooltips [#1536](https://xplodedthemes.com/issues/1536)
* Fix: Default System Font Stack for Sans Serif Fonts in Typography Fields [#1530](https://xplodedthemes.com/issues/1530)
* Fix: HTML entities in repeater text field being encoded on each save? [#1523](https://xplodedthemes.com/issues/1523)
* Fix: Some resetting issues [#1474](https://xplodedthemes.com/issues/1474)
* Fix: Allow saving image fields as arrays (url,id,width,height) [#1529](https://xplodedthemes.com/issues/1529)
* Fix: Allow saving image fields as ID [#1498](https://xplodedthemes.com/issues/1498)
...
* Fix: Performance Improvements in the autoloader [see commit](https://xplodedthemes.com/pull/1454/commits/dd518f7dc35cacf4f2ed571b033519b353aa2545)
* Fix: Undefined index notice in the `Xirki_Output` class.
* Fix: Sanitization for `checkbox`, `switch` and `toggle` controls.
* Fix: `select2` CSS fix for `z-index` [#1459](https://xplodedthemes.com/issues/1459)
* Fix: Remove button in image controls when there's no image [#1469](https://xplodedthemes.com/issues/1469)
* Fix: Background control styling issue when no other color control exists [#1472](https://xplodedthemes.com/issues/1472)
* Fix: Checkbox and Toggle don't respect "value_pattern" [#1467](https://xplodedthemes.com/issues/1467)
* Fix: Array to string conversion when clicking reset button [#1477](https://xplodedthemes.com/issues/1477)
* Fix: Input Field Validation Issue [#1486](https://xplodedthemes.com/issues/1486)
* Fix: Typography: output property not working [#1484](https://xplodedthemes.com/issues/1484)
* Fix: postMessage does not work properly when using `prefix` [#1479](https://xplodedthemes.com/issues/1479)
...
* Fix: Typography controls without a variant defined were adding font-weight in the customizer [#1436](https://xplodedthemes.com/issues/1436)
* Fix: Set default webfonts loading method to `link` [#1438](https://xplodedthemes.com/issues/1438)
* Fix: Bug that prevents custom args from being passed to custom controls [#1425](https://xplodedthemes.com/issues/1425). Props @danielortiz
* Fix: `exclude` argument in `output` when combined with `choice` [#1416](https://xplodedthemes.com/issues/1416)
* Fix: `active_callback` operators for greater/smaller etc [#1427](https://xplodedthemes.com/issues/1427)

## 3.0.7

June 26 2017, dev time: 1 hour.

* Fix: GoogleFonts links were not getting properly created [#1430](https://xplodedthemes.com/issues/1430)
* Fix: Incorrect logic when `Xirki::add_field()` only has 1 argument defined [#1429](https://xplodedthemes.com/issues/1429)
...
* Fix: Conflict with the MaxStore Pro theme [#1405](https://xplodedthemes.com/issues/1405)
* Fix: CSS Output for Typography controls [#1423](https://xplodedthemes.com/issues/1423)
* Fix: PHP Warning in Repeater control. [#1417](https://xplodedthemes.com/issues/1417)
* Fix: CSS conflict with the Shortcake plugin [#1418](https://xplodedthemes.com/issues/1418)
* Fix: `Xirki_Fonts_Google::$force_load_all_variants` was not working in version 3.0
* Fix: PHP Warning in typography control when the value was corrupted [#1426](https://xplodedthemes.com/issues/1426)
* Fix: Notice about incorrect `wp_add_inline_style` when googlefont URL was throwing error [#1410](https://xplodedthemes.com/issues/1410)
* Fix: Unable to delete the plugin when it's also embedded in the active theme and plugin version is deactivated [#1421](https://xplodedthemes.com/issues/1421)
...
* Fix: Added extra checks to avoid PHP Warning in the `Xirki_Fonts_Google` class [#1402](https://xplodedthemes.com/issues/1402).
* Fix: `fontawesome` control was throwing a warning in the theme-check plugin.
* Fix: Added the "Default" button back in image controls [#1401](https://xplodedthemes.com/issues/1401)
* Fix: Number controls sanitization memory issue [#1404](https://xplodedthemes.com/issues/1404)
* Fix: Typography controls font-weight output [#1370](https://xplodedthemes.com/issues/1370)
...
* Fix: Refactored the reset module. [#1334](https://xplodedthemes.com/pull/1334)
* Fix: Refactored the postMessage module [#1333](https://xplodedthemes.com/issues/1333)
* Fix: PHP mode on CodeMirror. [#1003](https://xplodedthemes.com/issues/1003)
...
* Fix: Tooltip height fix in [#1228](https://xplodedthemes.com/issues/1228)
* Fix: Tooltip not closing when clicking outside of icon [#1226](https://xplodedthemes.com/issues/1226)
* Fix: Issue with visual representation of color picker (alpha iris) [#1218](https://xplodedthemes.com/issues/1218)
* Fix: Reset is "undefined" [#1210](https://xplodedthemes.com/issues/1210)
* Fix: Controls that save arrays cause PHP Notices [#1199](https://xplodedthemes.com/issues/1199)
...
* Fix: required argument not work with postMessage type. [#1031](https://xplodedthemes.com/issues/1031)
* Fix: Notice: Undefined index, repeater field. [#1291](https://xplodedthemes.com/issues/1291)
...
* New: Allow modifying values instead of replacing them when using `js_vars` with `function` set to `html` by using the `value_pattern` parameter and the `$` placeholder. [#1137](https://xplodedthemes.com/pull/1137)
* New: Updated CodeMirror. [fff6df0](https://xplodedthemes.com/commit/34fdaa562fdd33fa595db927ee597265a753b3b4)
* New: Added word-spacing to the typography control. [#1163](https://xplodedthemes.com/issues/1163)
...
* New: Allow saving site-options(`'option_type' => 'site_option'`) [#1326](https://xplodedthemes.com/issues/1326)
* New: Added 2 new methods for enqueueing google fonts. See the [`xirki/googlefonts_load_method`](https://xplodedthemes.com/blob/9e3e4a6928339bdcd0f7520d305c145a80a06c8a/modules/webfonts/class-xirki-modules-webfonts.php#L100) filter.
...
* Fix: CSS prefixes order fixes ([#1042](https://xplodedthemes.com/pull/1042)).
* Fix: `suffix` output argument support in Multicolor control ([#1042](https://xplodedthemes.com/pull/1042)).
* Fix: `Xirki::get_variables()` method should be static ([#1050](https://xplodedthemes.com/pull/1050)).
* Fix: Add line wrapping to CodeMirror ([#1079](https://xplodedthemes.com/pull/1079)).
* Fix: `container_inclusive` is disregarded on the selective refresh class ([#1089](https://xplodedthemes.com/issues/1089)).
* Fix: Support `input_attrs` parameter for controls ([#1074](https://xplodedthemes.com/issues/1074)).
* Fix: Outdated Google-Fonts list ([#1091](https://xplodedthemes.com/issues/1091)).
...
* FIX: Missing button label in `code` fields ([#1017](https://xplodedthemes.com/issues/1017)).
* FIX: Better implementation when embedding Xirki in a theme ([#1025](https://xplodedthemes.com/issues/1025)).
* FIX: Updated google-fonts ([#1041](https://xplodedthemes.com/issues/1041)).
* NEW: Allow simpler format for `variables` argument ([#1020](https://xplodedthemes.com/issues/1020)).
...
* FIX: Editor field covering the content ([#955](https://xplodedthemes.com/issues/955)).
* FIX: Smoother transition for editor switching.
* FIX: Code field JS error when using "php" mode ([#958](https://xplodedthemes.com/issues/958)).
* FIX: `postMessage` for typography fields ([#528](https://xplodedthemes.com/issues/528)).
* FIX: translation strings ([#960](https://xplodedthemes.com/issues/960)).
* FIX: `postMessage` for `background-image` properties ([#963](https://xplodedthemes.com/issues/963)).
* FIX: Reset Typography Control without font-family default value ([#951](https://xplodedthemes.com/issues/951)).
* FIX: Typography field: font-style missing in CSS output if variant is regular/400 ([#977](https://xplodedthemes.com/issues/977)).
* FIX: Placing two editor controls in the customizer leads to odd behavior ([#140](https://xplodedthemes.com/issues/140)).
* FIX: Typography field: letter-spacing missing in CSS output if its value is 0 ([#978](https://xplodedthemes.com/issues/978)).
* FIX: Allow using HTML in section descriptions ([#976](https://xplodedthemes.com/issues/976)).
* FIX: Bug preventing partial refreshes from working properly ([#991](https://xplodedthemes.com/issues/991)).
* FIX: Better internationalization handling.
* FIX: Output errors on typography settings ([#975](https://xplodedthemes.com/issues/975)).
* NEW: Added a new `attr` argument to `js_vars` ([#957](https://xplodedthemes.com/issues/957)).
* NEW: Implemented both `AND` and `OR` conditionals in `active_callback` arrays ([#839](https://xplodedthemes.com/issues/839)).
...
* NEW: Added a new `xirki/{$config_id}/styles` filter ([#908](https://xplodedthemes.com/issues/908)).
* NEW: Added a `customize-control-xirki` class to all Xirki controls.
* FIX: Field type number : Cannot read property 'min' of undefined ([#911](https://xplodedthemes.com/issues/911)).
* FIX: All controls are now prefixed ([#918](https://xplodedthemes.com/issues/918))
* FIX: `alpha` argument in color-alpha controls ([#932](https://xplodedthemes.com/issues/932)).
...
* FIX: Placing 2 editor controls in the customizer leads to odd behaviour ([#140](https://xplodedthemes.com/issues/140)).
* FIX: `active_callback` conbined with the old `required` argument. ([#906](https://xplodedthemes.com/issues/906)).
* FIX: Double prefix and suffix in `js_vars` ([#943](https://xplodedthemes.com/issues/943)).
* FIX: Typography control returns both 'subset' and 'subsets' indexes with the same value ([#948](https://xplodedthemes.com/issues/948)).
...
* NEW: Included the ariColor library for color calculations (https://xplodedthemes.com/ariColor/)
...
* TWEAK: Removed demo theme from the plugin. This is now provided separately on https://xplodedthemes.com-demo
...
* NEW: Added a new API. See https://xplodedthemes.com/wiki for documentation.
...
* NEW: Added ability to get variables for CSS preprocessors from the customizer values. See https://xplodedthemes.com/wiki/variables for documentation
...
* NEW: Implement width argument in the styling options. See https://xplodedthemes.com/wiki/Styling-the-Customizer
